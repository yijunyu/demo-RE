...
@injectable()
export class ArgumentClientContribution extends BaseLanguageClientContribution {
...
export function registerDSL() {
    ...
    monaco.languages.register({
        ...
        extensions: ['.argument'],
        mimetypes: ['text/argument']
    })
    monaco.languages.setLanguageConfiguration('argument', {
        comments: {
            lineComment: "//",
            blockComment: ['/*', '*/']
        },
    ...
    monaco.languages.setMonarchTokensProvider('argument', <any>{
